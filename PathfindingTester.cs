        ...
        public override void Update()
        {
            ...
            else if (_currentState == SelectState.DestinationSelected)
            {
                ...
                if (mouseState.LeftButton == ButtonState.Released)
                {
                    ...
                    // Immediately thereafter, the state is transited back to Begin state.

                    try
                    {
                        /********************************************************************************
                            Problem 3 (a): Perform quantization by calculating 'srcTile' and 'destTile'
                                        using 'srcPoint' and 'destPoint' respectively.

                            HOWTOSOLVE : 1. Copy the code below.
                                         2. Paste it below this block comment.
                                         3. Fill in the blanks.

                            Tile srcTile = new Tile(________, ________);
                            Tile destTile = new Tile(________, ________);

                        ********************************************************************************/

                        Tile srcTile = new Tile(_srcPoint.X / _tiledMap.TileWidth, _srcPoint.Y / _tiledMap.TileHeight);
                        Tile destTile = new Tile(_destPoint.X / _tiledMap.TileWidth, _destPoint.Y / _tiledMap.TileHeight);
                        ...
                        /********************************************************************************
                            ...
                            path = AStar.Compute(________, ________, ________, ________);
